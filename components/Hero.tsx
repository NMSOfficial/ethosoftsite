...
const Hero: React.FC = () => {
  ...
  const container: Variants = {
    ...
    show: {
      ...
      transition: {
        staggerChildren: 0.1,
        delayChildren: 0.4 // Reduced from 2.6 since preloader is gone
      }
    }
  };
    ...
    <section id="hero" className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 text-center">
        <motion.div
          ...
          transition={{ duration: 1.2, delay: 0.2, ease: "easeOut" }} // Reduced delay
        ...
        <motion.p
          ...
          transition={{ duration: 0.8, delay: 1.0, ease: "easeOut" }} // Reduced delay
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, delay: 1.2 }} // Reduced delay
